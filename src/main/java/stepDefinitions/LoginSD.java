...
public class LoginSD {
    ...
    public void i_am_on_login_page() {
        System.out.println("output: >>> I am on login page");
    ...
    public void i_enter_correct_username_and_correct_password() {
        System.out.println("output: >>> I enter correct username and correct password");
    ...
    public void i_click_on_login_button() {
        System.out.println("output: >>> I click on login button");
        driver.findElement(By.xpath("//input[@name='submit']")).click();
    }

    @Then("I should be redirected to home page")
    public void i_should_be_redirected_to_home_page() {
        System.out.println("output: >>> I should be redirected to home page");
